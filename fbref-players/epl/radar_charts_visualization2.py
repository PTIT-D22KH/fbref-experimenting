...
def compare_players_and_create_radar(merged_df, player1, player2, col, params, lower_is_better):
    ...
    create_radar_chart(params, low, high, lower_is_better, player1_values, player2_values)
...
def main():
    ...
    compare_players_and_create_radar(merged_df, 'Bruno Fernandes', 'Kevin De Bruyne', col, params, lower_is_better)
